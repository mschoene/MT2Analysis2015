...
class MT2EstimateTree : public MT2Estimate {
 ...
 public:
  ...
  static MT2Analysis<MT2EstimateTree>* makeRebinnedAnalysisFromInclusiveTree( const std::string& aname, const std::string& regionsSet, MT2Analysis<MT2EstimateTree>* analysis, const std::string& selection="", int nBins=0, float xMin=0., float xMax=0., const std::string& variable="mt2" );

  static MT2Analysis<MT2EstimateTree>* makeRebinnedAnalysisFromInclusiveTree( const std::string& aname, const std::string& regionsSet, MT2Analysis<MT2EstimateTree>* analysis,  int nBins, double* bins, const std::string& selection="",const std::string& variable="mt2" );
