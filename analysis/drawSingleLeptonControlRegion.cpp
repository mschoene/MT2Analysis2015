...
int main( int argc, char* argv[] ) {
  ...
  std::string mcFile = cfg.getEventYieldDir() + "/singleLeptonControlRegion/mc.root";
  TFile* file_mc = TFile::Open(mcFile.c_str());
  TTree* tree_mc = (TTree*)file_mc->Get("slCRtree/HT450toInf_j2toInf_b0toInf/tree_slCRtree_HT450toInf_j2toInf_b0toInf");


  drawSingleVariable( cfg, tree, 
