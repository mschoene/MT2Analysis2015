...
cfg = "data_2016_SnT_36p8_02Feb"  #data_2016_SnTMC_362ifb_18ifbUB_Signal" #"data_Run2016_7p7ifb"

M = range(600 if "T1" in model else 100 if "T2tt"==model else 300,2301 if "T1" in model else 1801 if "T2qq"==model else 1500,25)
#M = range(600 if "T1" in model else 100 if "T2tt"==model else 300,900 if "T1" in model else 701 if "T2qq"==model else 900,100)
