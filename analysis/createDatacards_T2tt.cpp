...
//  std::vector<MT2Analysis<MT2EstimateSigSyst>*> signals_lepEff    = MT2Analysis<MT2EstimateSigSyst>::readAllSystFromFile( "./signalScansFromDominick/T2tt_sigcontam_eth.root", "T2tt_sigcontam", "lepeff" );
//  std::vector<MT2Analysis<MT2EstimateSigSyst>*> signals_bTagHeavy = MT2Analysis<MT2EstimateSigSyst>::readAllSystFromFile( "./signalScansFromDominick/T2tt_sigcontam_eth.root", "T2tt_sigcontam", "btagsf_heavy" );
//  std::vector<MT2Analysis<MT2EstimateSigSyst>*> signals_bTagLight = MT2Analysis<MT2EstimateSigSyst>::readAllSystFromFile( "./signalScansFromDominick/T2tt_sigcontam_eth.root", "T2tt_sigcontam", "btagsf_light" );
//  std::vector<MT2Analysis<MT2EstimateSigSyst>*> signals_isr       = MT2Analysis<MT2EstimateSigSyst>::readAllSystFromFile( "./signalScansFromDominick/T2tt_sigcontam_eth.root", "T2tt_sigcontam", "isr" );
//  std::vector<MT2Analysis<MT2EstimateSigContSyst>*> signals       = MT2Analysis<MT2EstimateSigContSyst>::readAllSystFromFile( "./signalScansFromDominick/T2tt_sigcontam_eth.root", "T2tt_sigcontam", "isr" );

  std::vector<MT2Analysis<MT2EstimateSigSyst>*> signals_lepEff    = MT2Analysis<MT2EstimateSigSyst>::readAllSystFromFile( "./signalScansFromDominick/T2tt_polL_sigcontam_eth.root", "T2tt_sigcontam", "lepeff" );
  std::vector<MT2Analysis<MT2EstimateSigSyst>*> signals_bTagHeavy = MT2Analysis<MT2EstimateSigSyst>::readAllSystFromFile( "./signalScansFromDominick/T2tt_polL_sigcontam_eth.root", "T2tt_sigcontam", "btagsf_heavy" );
  std::vector<MT2Analysis<MT2EstimateSigSyst>*> signals_bTagLight = MT2Analysis<MT2EstimateSigSyst>::readAllSystFromFile( "./signalScansFromDominick/T2tt_polL_sigcontam_eth.root", "T2tt_sigcontam", "btagsf_light" );
  std::vector<MT2Analysis<MT2EstimateSigSyst>*> signals_isr       = MT2Analysis<MT2EstimateSigSyst>::readAllSystFromFile( "./signalScansFromDominick/T2tt_polL_sigcontam_eth.root", "T2tt_sigcontam", "isr" );
  std::vector<MT2Analysis<MT2EstimateSigContSyst>*> signals       = MT2Analysis<MT2EstimateSigContSyst>::readAllSystFromFile( "./signalScansFromDominick/T2tt_polL_sigcontam_eth.root", "T2tt_sigcontam", "isr" );
  
//  signals_lepEff[0]    ->setName("T2tt");
//  signals_bTagHeavy[0] ->setName("T2tt");
//  signals_bTagLight[0] ->setName("T2tt");
//  signals_isr[0]       ->setName("T2tt");
//  signals[0]           ->setName("T2tt");
...
//	}
	...
	for( int iBinY=1; iBinY<this_signalParent->GetNbinsX()+1; ++iBinY ){
	  ...
	  for( int iBinZ=1; iBinZ < iBinY; ++iBinZ ) {
	    ...
	    std::cout << "Integral: " << this_signal->Integral() << std::endl;
		...
		std::cout << "There was a non empty bin!" << std::endl;
		...
		Long_t modtime;
		Long_t size;
		std::string fullPathSE = Form("/pnfs/psi.ch/cms/trivcat/store/user/mmasciov/datacards_T2tt_04Feb_left/%s_%.0f_%.0f/datacard_%s_%s_%.0f_%.0f.txt", pathSE.c_str(), mParent, mLSP, binName.c_str(), sigName.c_str(), mParent, mLSP);
...
//////		std::string helpDatacard( Form("%s/datacard_%s_%s_forSed.txt", path_mass.c_str(), binName.c_str(), sigName.c_str()) );
		...
		std::string mkdirOnSE( Form("env --unset=LD_LIBRARY_PATH gfal-mkdir -p srm://t3se01.psi.ch:8443/srm/managerv2?SFN=/pnfs/psi.ch/cms/trivcat/store/user/mmasciov/datacards_T2tt_04Feb_left/%s_%.0f_%.0f", pathSE.c_str(), mParent, mLSP) );
		std::string copyOnSE( Form("xrdcp -v %s root://t3dcachedb.psi.ch:1094///pnfs/psi.ch/cms/trivcat/store/user/mmasciov/datacards_T2tt_04Feb_left/%s_%.0f_%.0f/datacard_%s_%s_%.0f_%.0f.txt", newDatacard.c_str(), pathSE.c_str(), mParent, mLSP, binName.c_str(), sigName.c_str(), mParent, mLSP) );
