...
int main( int argc, char* argv[] ) {
  ...
  MT2Analysis<MT2EstimateZinvGamma>* multijet_ht = MT2EstimateZinvGamma::makeInclusiveAnalysisFromInclusiveTree( "iso_multijet_ht", data, cfg.crRegionsSet() , "nJets>1" , "ht" , size_ht, bins_ht ); 
  std::string outFile_multijet_ht = cfg.getGammaCRdir() + "/iso_multijet_ht.root";
  multijet_ht->writeToFile(outFile_multijet_ht, "recreate");

  MT2Analysis<MT2EstimateZinvGamma>* incl_ht = MT2EstimateZinvGamma::makeInclusiveAnalysisFromInclusiveTree( "iso_incl_ht", data, cfg.crRegionsSet() , "nJets>0" , "ht" , size_ht, bins_ht ); 
  std::string outFile_incl_ht = cfg.getGammaCRdir() + "/iso_incl_ht.root";
  incl_ht->writeToFile(outFile_incl_ht, "recreate");

  MT2Analysis<MT2EstimateZinvGamma>* incl_njets = MT2EstimateZinvGamma::makeInclusiveAnalysisFromInclusiveTree( "iso_incl_njets", data, cfg.crRegionsSet() ,"nJets>0", "nJets", size_incl_njets, bins_incl_njets ); 
  std::string outFile_incl_njets = cfg.getGammaCRdir() + "/iso_incl_nJets.root";
  incl_njets->writeToFile(outFile_incl_njets, "recreate");

  MT2Analysis<MT2EstimateZinvGamma>* incl_njets_mc = MT2EstimateZinvGamma::makeInclusiveAnalysisFromInclusiveTree( "iso_incl_njets_mc", mc, cfg.crRegionsSet() ,"nJets>0", "nJets", size_incl_njets, bins_incl_njets ); 
  incl_njets_mc->addToFile(outFile_incl_njets, "recreate");

  MT2Analysis<MT2EstimateZinvGamma>* incl_nbjets = MT2EstimateZinvGamma::makeInclusiveAnalysisFromInclusiveTree( "iso_incl_nbjets", data, cfg.crRegionsSet() ,"nJets>0" , "nBJets", size_nbjets, bins_nbjets );
...
////  purityTight_mt2->addToFile( outFile_purity_mt2 );
  ...
  MT2Analysis<MT2EstimateTree>* all_mono_ht =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "all_mono_ht", cfg.crRegionsSet(), mc , "(id>152.)", size_mono_ht, bins_mono_ht, "ht" ) ;
  
  MT2Analysis<MT2EstimateTree>* prompt_mono_ht =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_mono_ht", cfg.crRegionsSet(), mc ,  prompt+"&& (id>152.)", size_mono_ht, bins_mono_ht, "ht" ) ;
  ...
  MT2Analysis<MT2EstimateTree>* all_pass_mono_ht =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "all_pass_mono_ht", cfg.crRegionsSet(), mc , iso+"&& (id>152.)", size_mono_ht, bins_mono_ht,"ht");
  MT2Analysis<MT2EstimateTree>* prompt_tight_mono_ht =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_tight_mono_ht", cfg.crRegionsSet(), mc , iso+"&&"+prompt+"&& (id>152.)" , size_mono_ht, bins_mono_ht, "ht" ) ;
  ...
  /*
  //MULTIJET HT
  MT2Analysis<MT2EstimateTree>* all_ht =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "all_ht", cfg.crRegionsSet(), mc , multijet+"&& (id>152.)", size_ht, bins_ht, "ht" ) ;

  MT2Analysis<MT2EstimateTree>* prompt_ht =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_ht", cfg.crRegionsSet(), mc , multijet +"&&"+ prompt+"&& (id>152.)", size_ht, bins_ht, "ht" ) ;
  ...
  MT2Analysis<MT2EstimateTree>* all_pass_ht =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "all_pass_ht", cfg.crRegionsSet(), mc , multijet +"&&"+iso+"&& (id>152.)", size_ht, bins_ht,"ht");
  MT2Analysis<MT2EstimateTree>* prompt_tight_ht =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_tight_ht", cfg.crRegionsSet(), mc , multijet+"&&"+iso+"&&"+prompt+"&& (id>152.)" , size_ht, bins_ht, "ht" ) ;
  ...
  //NJETS
  MT2Analysis<MT2EstimateTree>* all_njets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree("all_njets", cfg.crRegionsSet(), mc , multijet + " && (id>152.)" , size_njets, bins_njets, "nJets");
  MT2Analysis<MT2EstimateTree>* prompt_njets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_njets", cfg.crRegionsSet(), mc , multijet +"&&"+ prompt+"&&(id>152.)", size_njets, bins_njets, "nJets" ) ;
  ...
  MT2Analysis<MT2EstimateTree>* all_pass_njets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "all_pass_njets", cfg.crRegionsSet(), mc ,  multijet + " && " + iso + " && (id>152.)", size_njets, bins_njets,"nJets");
  MT2Analysis<MT2EstimateTree>* prompt_tight_njets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_tight_njets", cfg.crRegionsSet(), mc ,  multijet + " && " + iso + " && "+ prompt + " && (id>152.)", size_njets, bins_njets, "nJets" ) ;
  ...
  MT2Analysis<MT2EstimateTree>* all_nbjets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree("all_nbjets", cfg.crRegionsSet(), mc,  multijet+"&& (id>152.)" , size_nbjets, bins_nbjets, "nBJets");
  MT2Analysis<MT2EstimateTree>* prompt_nbjets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_nbjets", cfg.crRegionsSet(), mc , multijet+"&&"+prompt+"&& (id>152.)" , size_nbjets, bins_nbjets, "nBJets" ) ;
  ...
  MT2Analysis<MT2EstimateTree>* all_pass_nbjets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "all_pass_nbjets", cfg.crRegionsSet(), mc ,  multijet +"&&"+ iso+"&& (id>152.)" , size_nbjets, bins_nbjets, "nBJets");
  MT2Analysis<MT2EstimateTree>* prompt_tight_nbjets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_tight_nbjets", cfg.crRegionsSet(), mc ,  multijet+"&&"+iso+"&&"+ prompt+"&& (id>152.)" , size_nbjets, bins_nbjets, "nBJets" ) ;
  ...
  */
  ...
  MT2Analysis<MT2EstimateTree>* all_mono_nbjets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree("all_mono_nbjets", cfg.crRegionsSet(), mc ,  monojet+"&& (id>152.)" , size_mono_nbjets, bins_mono_nbjets, "nBJets");
  MT2Analysis<MT2EstimateTree>* prompt_mono_nbjets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_mono_nbjets", cfg.crRegionsSet(), mc , monojet+"&&"+prompt+"&& (id>152.)", size_mono_nbjets, bins_mono_nbjets, "nBJets" ) ;

  MT2Analysis<MT2EstimateSyst>* purityLoose_mono_nbjets = MT2EstimateSyst::makeEfficiencyAnalysis( "purityLoose", cfg.crRegionsSet(), (MT2Analysis<MT2Estimate>*)prompt_mono_nbjets, (MT2Analysis<MT2Estimate>*)all_mono_nbjets);
 
  MT2Analysis<MT2EstimateTree>* all_pass_mono_nbjets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "all_pass_mono_nbjets", cfg.crRegionsSet(), mc , monojet+"&&"+iso+"&& (id>152.)", size_mono_nbjets, bins_mono_nbjets, "nBJets");
  MT2Analysis<MT2EstimateTree>* prompt_tight_mono_nbjets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_tight_mono_nbjets", cfg.crRegionsSet(), mc ,  monojet+"&&"+prompt+"&&"+iso+"&& (id>152.)", size_mono_nbjets, bins_mono_nbjets, "nBJets" ) ;
  ...
  MT2Analysis<MT2EstimateSyst>* purityTight_mono_nbjets = MT2EstimateSyst::makeEfficiencyAnalysis( "purity", cfg.crRegionsSet(), (MT2Analysis<MT2Estimate>*)prompt_tight_mono_nbjets, (MT2Analysis<MT2Estimate>*)all_pass_mono_nbjets);
  ...
  */
  ...
  MT2Analysis<MT2EstimateTree>* all_incl_ht =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "all_incl_ht", cfg.crRegionsSet(), mc , "(id>152.)", size_ht, bins_ht, "ht" ) ;

  MT2Analysis<MT2EstimateTree>* prompt_incl_ht =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_incl_ht", cfg.crRegionsSet(), mc ,  prompt+"&& (id>152.)", size_ht, bins_ht, "ht" ) ;
  ...
  MT2Analysis<MT2EstimateTree>* all_pass_incl_ht =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "all_pass_incl_ht", cfg.crRegionsSet(), mc , iso+"&& (id>152.)", size_ht, bins_ht,"ht");
  MT2Analysis<MT2EstimateTree>* prompt_tight_incl_ht =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_tight_incl_ht", cfg.crRegionsSet(), mc , iso+"&&"+prompt+"&& (id>152.)" , size_ht, bins_ht, "ht" ) ;
  ...
  //NJETS
  MT2Analysis<MT2EstimateTree>* all_incl_njets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree("all_incl_njets", cfg.crRegionsSet(), mc , "(id>152.)" , size_incl_njets, bins_incl_njets, "nJets");
  MT2Analysis<MT2EstimateTree>* prompt_incl_njets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_incl_njets", cfg.crRegionsSet(), mc , prompt+"&&(id>152.)", size_incl_njets, bins_incl_njets, "nJets" ) ;
  ...
  MT2Analysis<MT2EstimateTree>* all_pass_incl_njets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "all_pass_incl_njets", cfg.crRegionsSet(), mc , iso + " && (id>152.)", size_incl_njets, bins_incl_njets,"nJets");
  MT2Analysis<MT2EstimateTree>* prompt_tight_incl_njets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_tight_incl_njets", cfg.crRegionsSet(), mc , iso + " && "+ prompt + " && (id>152.)", size_incl_njets, bins_incl_njets, "nJets" ) ;
  ...
  MT2Analysis<MT2EstimateTree>* all_incl_nbjets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree("all_incl_nbjets", cfg.crRegionsSet(), mc,  "(id>152.)" , size_nbjets, bins_nbjets, "nBJets");
  MT2Analysis<MT2EstimateTree>* prompt_incl_nbjets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_incl_nbjets", cfg.crRegionsSet(), mc , prompt+"&& (id>152.)" , size_nbjets, bins_nbjets, "nBJets" ) ;
  ...
  MT2Analysis<MT2EstimateTree>* all_pass_incl_nbjets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "all_pass_incl_nbjets", cfg.crRegionsSet(), mc , iso+"&& (id>152.)" , size_nbjets, bins_nbjets, "nBJets");
  MT2Analysis<MT2EstimateTree>* prompt_tight_incl_nbjets =  MT2EstimateTree::makeRebinnedAnalysisFromInclusiveTree( "prompt_tight_incl_nbjets", cfg.crRegionsSet(), mc , iso+"&&"+ prompt+"&& (id>152.)" , size_nbjets, bins_nbjets, "nBJets" ) ;
