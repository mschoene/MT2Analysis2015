...
int main(int argc, char* argv[]){
  ...
  std::string selection = selection = "HLT_weight*weight_lep0*weight_lep1*(abs(Z_mass-91.19)<10 && met>200 && mt2>200 && ht>200 && nJets>0 && (Z_lepId==13 || (Z_lepId==11 && lep_tightId0>0 && lep_tightId1>0)))";
