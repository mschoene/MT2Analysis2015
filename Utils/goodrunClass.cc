...
int GoodRun::load_runs(const char *fname, enum file_type type){
...
bool GoodRun::goodrun (unsigned int run, unsigned int lumi_block)
{
...
bool GoodRun::goodrun_json (unsigned int run, unsigned int lumi_block)
{
  if (not good_runs_loaded_) {
...
void GoodRun::set_goodrun_file (const char* filename)
{
...
void GoodRun::set_goodrun_file_json (const char* filename)
{
